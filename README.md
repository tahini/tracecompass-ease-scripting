...
### Examples:
 ...
 - **examples/javascript/[diffCygProfile.js](examples/javascript/diffCygProfiles.js)**: This script draws a differential flame graph from 2 traces of the same workload: the cyg-profile traces that come with the [Trace Compass test traces](https://git.eclipse.org/c/tracecompass/tracecompass-test-traces.git/) repo.
