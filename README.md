...
### Examples:
 ...
 - **examples/python/[kMeanClusteringSciPy.py](examples/python/kMeanClusteringSciPy.py)** and **examples/python/[kMeanClusteringSciPy.py](examples/python/kMeanClusteringSklearn.py)**: Works with kernel trace, uses the matplotlib and numpy libraries. **[kMeanClusteringSciPy.py](examples/python/kMeanClusteringSciPy.py)** also uses the scipy library, and **[kMeanClusteringSciPy.py](examples/python/kMeanClusteringSklearn.py)** also uses the scikit-learn library. In the run arguments, leave one number for the desired number of clusters for the kmean algorithm.
